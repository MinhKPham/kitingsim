	...
	void Update () {
		...
		if (getshot == true) {
			...
			if (clicktomove.t1>=1f){
				...
				speed+=1f;
				GetComponent<Renderer>().material.color = originalColor;
								this.gameObject.transform.GetChild(0).GetComponent<Renderer>().material.color = originalColor;
								this.gameObject.transform.GetChild(1).GetComponent<Renderer>().material.color = originalColor;
				clicktomove.t1=0;
			}
